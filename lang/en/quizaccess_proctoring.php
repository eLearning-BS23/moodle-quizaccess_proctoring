...
$string['pro_version_products_text'] = 'View all products';
$string['pro_version_text'] = 'Learn more about Pro version';
...
$string['setting:validation_max'] = 'Value must be at most {$a}.';
$string['setting:validation_min'] = 'Value must be at least {$a}.';
